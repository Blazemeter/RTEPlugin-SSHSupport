...
Check our general design of classes [UML](https://github.com/Blazemeter/RTEPlugin/blob/master/docs/class-diagram.puml).
...
The following Docker commands should be run to build and publish the new image to the private Docker registry.
  ```
