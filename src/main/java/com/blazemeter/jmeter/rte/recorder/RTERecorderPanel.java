...
public class RTERecorderPanel extends JPanel implements ActionListener, RecordingStateListener {
  ...
  public boolean useSsh() {
    return configPanel.useSsh();
  }

  public void setUseSsh(boolean useSsh) {
    configPanel.setUseSsh(useSsh);
  }

  public String getSshCredentialType() {
    return configPanel.getSshCredentialType();
  }

  public void setSshCredentialType(String credentialType) {
    configPanel.setSshCredentialType(credentialType);
  }

  public String getUsername() {
    return configPanel.getUsername();
  }

  public void setUsername(String username) {
    configPanel.setUsername(username);
  }

  public String getPassword() {
    return configPanel.getPassword();
  }

  public void setPassword(String password) {
    configPanel.setPassword(password);
  }
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    } catch (UnsupportedOperationException | RteIOException ex) {
