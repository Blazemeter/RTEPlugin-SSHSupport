...
public class RTERecorderGui extends LogicControllerGui implements JMeterGUIComponent,
  ...
  public RTERecorderGui() {
    ...
    add(new BlazemeterLabsLogo("https://github.com/Blazemeter/RTEPlugin/"), BorderLayout.AFTER_LAST_LINE);
  ...
  public void modifyTestElement(TestElement te) {
    ...
    if (te instanceof RTERecorder) {
      ...
      recorder.setUseSsh(recordingPanel.useSsh());
      recorder.setSshCredentialType(recordingPanel.getSshCredentialType());
      recorder.setUsername(recordingPanel.getUsername());
      recorder.setPassword(recordingPanel.getPassword());
    }
  }
  ...
  public void configure(TestElement element) {
    ...
    if (element instanceof RTERecorder) {
      ...
      recordingPanel.setUseSsh(recorder.useSsh());
      recordingPanel.setSshCredentialType(recorder.getSshCredentialType());
      recordingPanel.setPassword(recorder.getPassword());
      recordingPanel.setUsername(recorder.getUsername());
    }
  }
