...
public class RTEConfigGui extends AbstractConfigGui {
  ...
  public void configure(TestElement element) {
    ...
    if (element instanceof ConfigTestElement) {
      ...
      rteConfigPanelConfigPanel.setUseSsh(configTestElement.getPropertyAsBoolean(
              RTESampler.CONFIG_USE_SSH, false));
      rteConfigPanelConfigPanel.setSshCredentialType(configTestElement.getPropertyAsString(
              RTESampler.CONFIG_SSH_CREDENTIALS_TYPE, "By Property"));
      rteConfigPanelConfigPanel.setUsername(configTestElement.getPropertyAsString(
              RTESampler.CONFIG_SSH_USERNAME, ""));
      rteConfigPanelConfigPanel.setPassword(configTestElement.getPropertyAsString(
              RTESampler.CONFIG_SSH_PASSWORD, ""));
    }
  }
  ...
  public void modifyTestElement(TestElement te) {
    ...
    if (te instanceof ConfigTestElement) {
      ...
      configTestElement.setProperty(RTESampler.CONFIG_USE_SSH,
              rteConfigPanelConfigPanel.useSsh());
      configTestElement.setProperty(RTESampler.CONFIG_SSH_CREDENTIALS_TYPE,
              rteConfigPanelConfigPanel.getSshCredentialType());
      configTestElement.setProperty(RTESampler.CONFIG_SSH_USERNAME,
              rteConfigPanelConfigPanel.getUsername());
      configTestElement.setProperty(RTESampler.CONFIG_SSH_PASSWORD,
              rteConfigPanelConfigPanel.getPassword());
    }
  }
