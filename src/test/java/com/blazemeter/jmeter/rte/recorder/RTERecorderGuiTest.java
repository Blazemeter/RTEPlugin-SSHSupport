...
public class RTERecorderGuiTest {
  ...
  @Test
  public void shouldNotifyRecorderOnRecordingStartWhenOnRecordingStart() throws RteIOException {
  ...
  @Test
  public void shouldNotifyRecorderWhenOnRecordingStop() throws RteIOException {
    rteRecorderGui.configure(testElement);
    rteRecorderGui.modifyTestElement(testElement);
    rteRecorderGui.onRecordingStart();
