...
public abstract class RteProtocolClientIT<T extends RteProtocolClient> {
  ...
  protected void connectToVirtualService() throws Exception {
    TerminalType defaultTerminalType = getDefaultTerminalType();
    client.configureClient(defaultTerminalType, SSLType.NONE, VIRTUAL_SERVER_HOST);
    client.connect(VIRTUAL_SERVER_HOST, server.getPort(), SSLType.NONE, defaultTerminalType,
        TIMEOUT_MILLIS);
    client.await(
